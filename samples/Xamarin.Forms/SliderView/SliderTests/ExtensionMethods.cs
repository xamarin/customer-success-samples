...
namespace SliderTests
{
	...
	{
		public static void SwipeLeft(this IApp app, float rightX, float leftX, float Y, string screenshot)
		{
			app.DragCoordinates (rightX, Y, leftX, Y);
			app.Screenshot (screenshot);
			Thread.Sleep (500);
		}

		public static void SwipeRight(this IApp app, float leftX, float rightX, float Y, string screenshot)
		{
			app.DragCoordinates (leftX, Y, rightX, Y);
			app.Screenshot (screenshot);
			Thread.Sleep (500);
		}
